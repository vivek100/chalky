  ...
  return (
    <MockActionProvider>
      ...
      <main className="moss-container py-16">
        ...
        <p className="mt-5 max-w-2xl text-lg leading-8 text-moss-muted">Use these paths to test whether another agent can click, browse, search, and explain the local Moss mock during a live demo.</p>
