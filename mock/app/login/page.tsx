    ...
    <main className="grid min-h-screen bg-moss-soft md:grid-cols-[1fr_520px]">
      <section className="hidden flex-col justify-between bg-moss-ink p-10 text-white md:flex">
        <div className="flex items-center gap-2">
          ...
          <span className="rounded-full border border-white/15 px-2 py-0.5 text-xs text-white/70">Demo Mock</span>
        </div>
        <div className="max-w-lg">
          ...
          <p className="mt-6 text-base leading-7 text-white/65">This mock portal accepts any email and password so demos can continue without touching Moss production auth.</p>
        </div>
