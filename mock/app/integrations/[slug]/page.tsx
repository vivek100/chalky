      ...
      <main>
        <section className="moss-container pb-12 pt-10">
          ...
          <div className="mt-10 max-w-4xl">
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              <MockActionButton title="Get Started">Get Started →</MockActionButton>
              <MockActionButton title="Talk to an Engineer" variant="light">Talk to an Engineer</MockActionButton>
        ...
        <section className="moss-container">
          <div className="rounded-3xl bg-moss-ink p-8 text-white sm:p-10">
            ...
            <p className="mt-4 max-w-2xl text-sm leading-6 text-white/70">Join teams building conversational AI with instant retrieval. This local demo keeps account actions mocked.</p>
            <div className="mt-6 flex flex-wrap gap-3">
              <MockActionButton title="Start Building" variant="light">Start Building</MockActionButton>
              <MockActionButton title="Talk to Founders" variant="light">Talk to Founders</MockActionButton>
            </div>
          </div>
        </section>
      </main>
