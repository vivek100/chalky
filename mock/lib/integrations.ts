...
const sharedFaqs = [
  {
    ...
    answer: "No. This is a local demo mock. Real credentials, indexes, and production API calls are intentionally not used."
  },
  {
...
export async function POST(req: NextRequest) {
  ...
  return NextResponse.json({
    ...
    faqs: [
      { question: "What does VAPI send to the webhook?", answer: "A real VAPI configuration sends the user query or conversation context; this mock shows the route shape without transmitting anything." },
      ...sharedFaqs
    ]
  },
  {
