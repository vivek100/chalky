      ...
      <div className="moss-container grid gap-10 py-12 md:grid-cols-[1.4fr_2fr]">
        <div>
          <div className="flex items-center gap-2">
            ...
            <span className="rounded-full border border-moss-line bg-white px-2 py-0.5 text-xs text-moss-muted">Demo Mock</span>
          </div>
          <p className="mt-4 max-w-sm text-sm leading-6 text-moss-muted">Real-time semantic search for Conversational AI. Local demo clone preserving attribution to Moss.</p>
